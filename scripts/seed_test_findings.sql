...
VALUES
    ...
    ('finding-003', '11111111-1111-1111-1111-111111111111', 'com.example.testapp-1.0.0',
     ...
     E'Analyzed network_security_config.xml:\n- cleartextTrafficPermitted: false\n- trust-anchors: system certificates\n- pin-set: NOT CONFIGURED\n\nWithout certificate pinning, MITM attacks are possible even with HTTPS.',
    ...
    ('finding-011', '11111111-1111-1111-1111-111111111111', 'com.example.testapp-1.0.0',
     ...
     'AndroidManifest.xml contains android:allowBackup="true" at line 15',
